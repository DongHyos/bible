...
public class ChapterQuery {
    ...
    /**
     * BibleVerse 리스트로부터 ChapterQuery 생성
     */
    public static ChapterQuery of(Integer bookId, String bookName, Integer chapter, List<BibleVerse> bibleVerses) {
     ...
     */
    public static ChapterQuery of(Integer chapter, List<BibleVerse> bibleVerses) {
        if (bibleVerses == null || bibleVerses.isEmpty()) {
            throw new IllegalArgumentException("Verses cannot be empty for chapter");
        }
    ...
    public String toString() {
        return String.format("ChapterQuery{book='%s %d', totalVerses=%d}",
