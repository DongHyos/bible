...
public class VerseRangeQueryDto {
     ...
     */
    public static VerseRangeQueryDto of(Integer bookId, Integer chapter, Integer startVerse, Integer endVerse, List<BibleVerse> bibleVerses) {
     ...
     */
    public static VerseRangeQueryDto of(Integer startVerse, Integer endVerse, List<BibleVerse> bibleVerses) {
    ...
    public String toString() {
        return String.format("VerseRangeQueryDto{range='%s', actualCount=%d/%d}",
