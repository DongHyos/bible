...
class JpaBibleVerseRepositoryTest {
    @Autowired
    ...
    private KrvBook testBook;
    private KrvVerse testVerse1;
    private KrvVerse testVerse2;

    @BeforeEach
    void setUp() {
        // 테스트용 책 생성 (Builder 패턴 사용)
        testBook = KrvBook.builder()
                .name("요한복음")
                .abbr("요")
